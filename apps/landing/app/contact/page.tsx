        ...
        <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 bg-white overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-muted leading-relaxed">
              Whether you have a question, want a demo, or just want to talk
              about your upcoming event - we're here.
            </p>
          </div>
        </section>
              ...
              <div className="lg:col-span-2 space-y-8">
                      ...
                      <div key={i} className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          {item.href ? (
                            <a
                              href={item.href}
                              className="text-foreground font-semibold hover:text-primary smooth-transition"
                            >
                              {item.value}
                            </a>
                          ) : (
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/15">
                  ...
                  <p className="text-sm text-muted leading-relaxed">
                    For urgent event-day support, there is a seperate 24h
                    support line when you conducting your event thought EventUp.
                  </p>
                </div>
                  ...
                  {submitted ? (
                    <div className="text-center py-10">
                      ...
                      <p className="text-muted">
                        We'll get back to you ASAP. Thanks for reaching out!
                      </p>
                    </div>
                  ) : (
