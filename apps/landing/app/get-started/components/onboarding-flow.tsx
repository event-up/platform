      ...
      <div className="flex flex-col items-center justify-center text-center space-y-8 animate-fade-in duration-500 max-w-xl mx-auto py-10 px-4">
        ...
        <div className="bg-primary/5 rounded-2xl p-6 md:p-8 w-full border border-primary/10 text-left">
          <h3 className="font-semibold text-lg mb-4 text-foreground">
            Can not wait until the platofrm is ready ?
          </h3>
          <ul className="space-y-4">
            ...
            <li className="flex items-start">
              <CheckCircle2 className="h-5 w-5 text-primary shrink-0 mr-3 mt-0.5" />
              <span className="text-foreground">
                We will create you a beatiful customized invitations for your
                event{" "}
              </span>
            </li>
            <li className="flex items-start">
        ...
        <div className="flex flex-col w-full gap-4 pt-4">
          <Button
            size="lg"
            className="w-full text-lg h-14 bg-primary text-white flex items-center justify-center group"
            href={`tel:+94775444169`}
          >
            <Phone className="mr-2 h-5 w-5 group-hover:animate-pulse" />
            <span className="md:hidden">Ring Us Now</span>
            <span className="hidden md:inline">Ring us : +94 775 444 169</span>
          </Button>
          <Button
            size="lg"
            variant="secondary"
            className="w-full text h-14 flex items-center justify-center cursor-pointer"
            href="/"
          >
            <ArrowLeft className="mr-2 h-5 w-5" /> Go Back (We will ring you
            shortly)
          </Button>
        </div>

        <p className="text-sm text-muted mt-8">
          We've also sent a summary to your email, along with our "Professional
          Organizer's Guide to Digital Check-ins".
        </p>
      </div>
    );
  }
    ...
    <div className="flex flex-col space-y-8 max-w-xl mx-auto px-4">
      <div className="space-y-4 text-center">
        ...
        <p className="text-lg text-muted leading-relaxed">
          Tell us about your upcoming event. We are in the process of finalzing
          our platform and would love to have you on board as a beta partner.
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-100 shadow-xl shadow-gray-200/50 rounded-2xl p-6 md:p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="text-lg font-semibold border-b border-gray-100 pb-2 text-gray-900">
              Contact Details
            </div>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="space-y-2">
              ...
              <input
                id="company"
                name="company"
                placeholder="EventUp Productions"
                className={inputClasses}
              />
            </div>
